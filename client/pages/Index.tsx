...
export default function Index() {
  ...
  const calculateItem = useCallback((data: any) => {
    ...
    return {
      ...
      brickQuantity,
      plasterArea,
      materials: { cement, sand, aggregate, brick: brickQuantity, steel },
      totalCost,
    };
  }, [customRates]);
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-brand-500 to-brand-600 rounded-xl">
                <img
